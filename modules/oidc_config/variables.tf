...
variable workspace_name{
    description = "The name of the workspace to access"
}
...
variable project_name{
    description = "The name of the project that the workspace lives under"
}



variable enable_vault_dynamic_workspace_creds{
  type=bool
  description = "Do we need Dynamic Workspace Credentials for Vault? true/false"
  default=false
}
